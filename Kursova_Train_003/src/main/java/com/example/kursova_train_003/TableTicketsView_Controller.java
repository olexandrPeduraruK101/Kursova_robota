...
public class TableTicketsView_Controller implements Initializable {
    ...
    void btnResetA(ActionEvent event) {
        ...
        btnPlus1.setDisable(true);
        cmbPlus1.getItems().clear();

        warning3.setText("");
        cmbPlus2.setDisable(true);
        btnPlus2.setDisable(true);
        fillComboBoxWithUserId();

        warning4.setText("");
        btnPlusOk.setDisable(true);
    ...
    void btnPlus0A(ActionEvent event) {
        ...
        if (cmbPlus0.getSelectionModel().isEmpty()) {
            ...
            cmbPlus0.setDisable(true);
            btnPlus0.setDisable(true);

            cmbPlus1.setDisable(false);
            btnPlus1.setDisable(false);
    ...
    void btnPlus1A(ActionEvent event) {
        ...
        if (cmbPlus1.getSelectionModel().isEmpty()) {
            ...
            cmbPlus2.setDisable(false);
            btnPlus2.setDisable(false);
    ...
    void btnPlusOkA(ActionEvent event) {
        ...
        if(tPlus0.getText().equals("")){
            ...
            if (input.matches("^\\d+(\\.\\d+)?$")) {
                ...
                addTickets();
                showTickets();
                methods.addTicketAndBookSeat(tickets.getTrainId(),tickets.getSeatId());
                btnResetA(event);
            }
            else{
...
//----------------------------------------------------------------------------------------
    ...
    void btnDeleteA(ActionEvent event) {
        ...
        if (tDelete.getText().equals("")) {
            ...
            try {
                methods.removeTicketAndFreeSeat(tickets);
